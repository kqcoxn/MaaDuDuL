...
## 更新摘要
**变更内容**  
- 更新了"启动游戏"流水线配置，包括viewport调整、坐标更新和新增关闭按钮图片支持
...
**本节引用**  
- [start_game.md:1-17](file://descs/daily/start_game.md#L1-L17)
- [claim_mail.md:1-13](file://descs/daily/claim_mail.md#L1-L13)
- [leaf_change.md:1-13](file://descs/daily/leaf_change.md#L1-L13)

## 典型任务执行流程分析

### 启动游戏任务流程

"启动游戏"任务经过更新后，包含了更完善的界面识别和操作流程。新版本增加了对多种关闭按钮的支持，包括黑色、黄色、棕色、黑白、透明、橙色、浅橙色和粉色等不同样式的关闭按钮图片。
...
**本节引用**  
- [农场视察.json:1-458](file://assets/resource/base/pipeline/日常任务/农场视察.json#L1-L458)
- [farm.md:1-13](file://descs/daily/farm.md#L1-L13)
