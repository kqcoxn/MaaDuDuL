...
- [farm.md](file://assets/resource/descs/daily/farm.md)
</cite>

## 更新摘要
**变更内容**  
- 更新了"启动游戏"流水线配置，包括新增关闭公告按钮检测、多状态界面处理能力提升、新的视口定位和更新结束导航步骤
...
**图源**  
- [启动游戏.json:1-458](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L1-L458)
...
"启动游戏"任务经过更新后，包含了更完善的界面识别和操作流程。新版本增加了对多种关闭按钮的支持，包括黑色、黄色、棕色、黑白、透明、橙色、浅橙色和粉色等不同样式的关闭按钮图片。同时新增了更新结束导航步骤，提升了多状态界面处理能力。
...
**图源**  
- [农场视察.json:1-458](file://assets/resource/base/pipeline/日常任务/农场视察.json#L1-L458)

**本节引用**  
- [农场视察.json:1-458](file://assets/resource/base/pipeline/日常任务/农场视察.json#L1-L458)
- [farm.md:1-13](file://assets/resource/descs/daily/farm.md#L1-L13)
...
**图源**  
- [activity.py:1-102](file://agent/customs/special_treat/activity.py#L1-L102)

**本节引用**  
- [activity.py:1-102](file://agent/customs/special_treat/activity.py#L1-L102)
- [领取糖果.json:1-318](file://assets/resource/base/pipeline/日常任务/领取糖果.json#L1-L318)
...
**更新** 新增了启动游戏管道的多项增强功能，包括关闭公告按钮检测、多状态界面处理能力和新的视口定位配置。

#### 关闭公告按钮检测增强

启动游戏管道现在包含专门的公告检测和关闭机制：
- `启动游戏_检测公告界面`节点：通过OCR识别"系统公告"标题
- `启动游戏_关闭公告`节点：使用模板匹配识别并点击公告关闭按钮
- ROI区域优化：针对公告界面的特定区域进行检测
...
**图源**  
- [启动游戏.json:89-458](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L89-L458)
