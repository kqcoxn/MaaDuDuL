...
- [agent/customs/special_treat/exam_cram.py](file://agent/customs/special_treat/exam_cram.py)
- [assets/resource/base/pipeline/日常任务/短期速成班.json](file://assets/resource/base/pipeline/日常任务/短期速成班.json)
- [assets/resource/tasks/daily/exam_cram.json](file://assets/resource/tasks/daily/exam_cram.json)
- [assets/resource/descs/daily/exam_cram.md](file://assets/resource/descs/daily/exam_cram.md)
- [.github/versions.json](file://.github/versions.json)
- [package.json](file://package.json)
- [assets/resource/Changelog.md](file://assets/resource/Changelog.md)
- [MFAAvalonia/Resource/Changelog.md](file://MFAAvalonia/Resource/Changelog.md)
- [assets/resource/Announcement/90.更新记录.md](file://assets/resource/Announcement/90.更新记录.md)
- [MFAAvalonia/Resource/Announcement/90.更新记录.md](file://MFAAvalonia/Resource/Announcement/90.更新记录.md)
</cite>

## 更新摘要
**所做更改**   
- 更新版本信息：从v0.2.6升级到v0.2.7
- 新增v0.2.7版本的主要改进内容
- 更新依赖框架版本信息
- 完善版本更新记录和变更说明
...
**重要更新**：项目已升级至v0.2.7版本，本次更新解决了启动游戏无法自动更新的问题，修复了邀请客人后可能卡在上菜的问题，并优化了签到面板识别速度。同时，项目依赖的MaaFramework版本更新至v5.9.2，MFAAvalonia版本更新至v2.11.8。

**Section sources**
- [README.md:1-122](file://README.md#L1-L122)
- [.github/versions.json:1-5](file://.github/versions.json#L1-L5)
- [assets/resource/Changelog.md:1-29](file://assets/resource/Changelog.md#L1-L29)
- [MFAAvalonia/Resource/Changelog.md:1-29](file://MFAAvalonia/Resource/Changelog.md#L1-L29)
...
- [assets/interface.json:1-87](file://assets/interface.json#L1-L87)
...
- [assets/interface.json:1-87](file://assets/interface.json#L1-L87)
- [agent/main.py:1-78](file://agent/main.py#L1-L78)
- [agent/customs/maahelper/tasker.py:1-177](file://agent/customs/maahelper/tasker.py#L1-L177)
...
**图表来源**
- [agent/customs/global_func/logic_enhance.py:1-96](file://agent/customs/global_func/logic_enhance.py#L1-L96)
...
1. **管道配置**：`短期速成班.json`定义了完整的任务流程，包括关卡选择、战斗执行和结果处理
2. **任务定义**：`exam_cram.json`提供了用户可配置的选项，包括周期检查、作战模式和周末关卡选择
3. **自定义动作**：`SelectCramLevel`类实现了智能关卡选择逻辑，根据游戏日期自动确定最优关卡

```mermaid
graph TD
subgraph "短期速成班功能"
ExamCram[ExamCram任务]
SelectLevel[SelectCramLevel自定义动作]
Pipeline[短期速成班管道]
Config[exam_cram.json配置]
Desc[考试速成说明]
end
ExamCram --> SelectLevel
ExamCram --> Pipeline
ExamCram --> Config
ExamCram --> Desc
SelectLevel --> Pipeline
```

**图表来源**
- [assets/resource/base/pipeline/日常任务/短期速成班.json:1-440](file://assets/resource/base/pipeline/日常任务/短期速成班.json#L1-L440)
- [assets/resource/tasks/daily/exam_cram.json:1-72](file://assets/resource/tasks/daily/exam_cram.json#L1-L72)
- [agent/customs/special_treat/exam_cram.py:1-79](file://agent/customs/special_treat/exam_cram.py#L1-L79)

**Section sources**
- [assets/resource/base/pipeline/日常任务/短期速成班.json:1-440](file://assets/resource/base/pipeline/日常任务/短期速成班.json#L1-L440)
- [assets/resource/tasks/daily/exam_cram.json:1-72](file://assets/resource/tasks/daily/exam_cram.json#L1-L72)
- [assets/resource/descs/daily/exam_cram.md:1-15](file://assets/resource/descs/daily/exam_cram.md#L1-L15)
- [agent/customs/special_treat/exam_cram.py:1-79](file://agent/customs/special_treat/exam_cram.py#L1-L79)
- [MFAAvalonia/agent/customs/special_treat/exam_cram.py:1-85](file://MFAAvalonia/agent/customs/special_treat/exam_cram.py#L1-L85)
...
4. **启动游戏问题**：v0.2.7版本已修复启动游戏无法自动更新的问题，如遇问题请检查游戏版本兼容性。
5. **邀请客人卡顿**：v0.2.7版本修复了邀请客人后可能卡在上菜的问题，如遇此问题请重新启动任务。
...
MaaDuDuL是一款功能强大且易于使用的自动化助手，适用于《嘟嘟脸恶作剧》游戏的日常任务自动化。通过结合MaaFramework和MFAAvalonia，MaaDuDuL实现了高效、稳定的自动化操作。

**重要更新**：项目已升级至v0.2.7版本，本次更新解决了多个关键问题并优化了用户体验。主要改进包括：
- 修复启动游戏无法自动更新的问题
- 修复邀请客人后可能卡在上菜的问题  
- 优化签到面板识别速度
- 更新依赖框架版本至最新稳定版本

无论是初学者还是高级开发者，都可以轻松上手并扩展其功能。希望本文档能帮助您更好地理解和使用MaaDuDuL。

**Section sources**
- [README.md:28-72](file://README.md#L28-L72)
- [assets/resource/Announcement/90.更新记录.md:23-33](file://assets/resource/Announcement/90.更新记录.md#L23-L33)
- [.github/versions.json:1-5](file://.github/versions.json#L1-L5)