...
- [claim_mail.md](file://assets/descs/daily/claim_mail.md)
...
**更新** 版本现已升级至 v0.2.7，包含多项问题修复和功能优化，包括启动游戏自动更新修复、邀请客人后卡顿问题修复以及签到面板识别速度优化。

本软件基于MaaFramework与MFAAvalonia技术栈构建，通过模拟操作与图像识别实现自动化。使用前请务必阅读用户协议并理解相关风险。

**Section sources**
- [README.md:1-122](file://README.md#L1-L122)
- [开始.md:1-36](file://docsite/docs/10.用户手册/10.旅程的开始/01.开始.md#L1-L36)
- [Changelog.md:1-29](file://assets/resource/Changelog.md#L1-L29)
...
- [下载与安装.md:1-146](file://docsite/docs/10.用户手册/10.旅程的开始/10.下载与安装.md#L1-L146)
...
2. 根据系统选择对应版本：
   - Windows用户下载`MaaDuDuL-win-x86_64-v0.2.7.zip`
   - macOS用户下载`MaaDuDuL-macos-aarch64-v0.2.7.zip`
   - Linux用户下载`MaaDuDuL-linux-x86_64-v0.2.7.zip`
...
**Diagram sources**
- [install.py:1-131](file://tools/install.py#L1-L131)
...
**Section sources**
- [启动与初始化.md:1-70](file://docsite/docs/10.用户手册/10.旅程的开始/20.启动与初始化.md#L1-L70)
- [interface.json:14-28](file://assets/interface.json#L14-L28)
...
- [interface.json:29-34](file://assets/interface.json#L29-L34)
- [install.py:51-64](file://tools/install.py#L51-L64)
...
**Section sources**
- [启动与初始化.md:55-65](file://docsite/docs/10.用户手册/10.旅程的开始/20.启动与初始化.md#L55-L65)
- [interface.json:18-19](file://assets/interface.json#L18-L19)
...
**Diagram sources**
- [claim_mail.md:1-13](file://assets/descs/daily/claim_mail.md#L1-L13)
- [interface.json:66-72](file://assets/interface.json#L66-L72)
...
**Section sources**
- [启动与初始化.md:55-65](file://docsite/docs/10.用户手册/10.旅程的开始/20.启动与初始化.md#L55-L65)
- [setup.py:135-197](file://agent/preprocess/setup.py#L135-L197)
...
**Diagram sources**
- [MaaDuDuL.py:1-22](file://launcher/MaaDuDuL.py#L1-L22)
- [main.py:1-48](file://agent/main.py#L1-L48)
- [clear.py:1-41](file://agent/preprocess/clear.py#L1-L41)
...
### 数据上报机制
系统会在启动时自动上报版本信息到统计服务器，版本号为 `v0.2.7`，用于收集使用统计数据和改进用户体验。

**Section sources**
- [Changelog.md:1-29](file://assets/resource/Changelog.md#L1-L29)
- [report.py:24-25](file://agent/devops/report.py#L24-L25)