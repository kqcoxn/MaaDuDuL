...
## 更新摘要
**变更内容**   
- 更新了“巅峰对决”中对手选择策略的说明，新增智能模式逻辑
- 扩展了“流程跳转逻辑设计”和“OCR识别在状态判断中的作用”两节内容
- 新增“智能对手选择策略”章节，详细说明基于战力对比的决策机制
- 更新了相关流程图以反映新的智能选择逻辑
...
**图示来源**
- [peak_showdown.py](file://agent/customs/special_treat/peak_showdown.py#L75-L116)
- [巅峰对决.json](file://assets/resource/base/pipeline/日常任务/巅峰对决.json#L515-L518)

**本节来源**
- [peak_showdown.py](file://agent/customs/special_treat/peak_showdown.py#L50-L116)
- [巅峰对决.json](file://assets/resource/base/pipeline/日常任务/巅峰对决.json)
