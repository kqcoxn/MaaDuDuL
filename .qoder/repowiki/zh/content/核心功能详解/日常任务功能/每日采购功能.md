...
**图表来源**
- [每日采购.json:25-1451](file://assets/resource/base/pipeline/日常任务/每日采购.json#L25-L1451)
- [store.py:21-95](file://agent/customs/special_treat/store.py#L21-L95)
...
Tasker --> Controller : "调用"
```

**图表来源**
- [store.py:52-96](file://agent/customs/special_treat/store.py#L52-L96)
...
**图表来源**
- [store.py:59-95](file://agent/customs/special_treat/store.py#L59-L95)
- [tasker.py:60-122](file://agent/customs/maahelper/tasker.py#L60-L122)
...
**图表来源**
- [store.py:10-11](file://agent/customs/special_treat/store.py#L10-L11)
...
该功能为MaaDuDuL项目提供了坚实的基础，也为其他类似自动化需求提供了优秀的参考模板。