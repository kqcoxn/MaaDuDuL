...
MaaDuDuL的日常任务自动化功能旨在通过自动化脚本完成游戏中的重复性操作，提升资源获取效率。该功能模块包含"领取邮件"、"每日采购"、"清紫糖"、"叶子互换"、"领取奖励"和"每日活动作战"等子功能，均被标记为【可连续任务】【日常任务】，支持从任意界面启动，并在执行完毕后返回主界面。
