...
- [农场视察.json](file://MFAAvalonia/resource/base/pipeline/日常任务/农场视察.json)
...
新增的"农场视察"任务也采用了相同的周期检查机制，通过"农场视察-周期检查"选项控制是否执行周期性检查：
...
该机制基于`periodic_check.py`模块实现，该模块提供了按天、周、月判断任务是否已完成的功能，并考虑了游戏凌晨4点刷新的特性，确保周期判断符合游戏逻辑。
...
此外，"清紫糖"任务也新增了"清紫糖-周期检查"选项，用于控制是否执行周期性检查：
