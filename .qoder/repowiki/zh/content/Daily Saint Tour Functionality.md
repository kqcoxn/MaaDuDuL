...
## 更新摘要
**变更内容**
- **坐标参数修正**：更新客人邀请系统的坐标参数，优化客人列表下滑和点击精度
- **界面适配改进**：更新viewport坐标以提升界面识别准确性
- **识别方法优化**：将菜单检测方法从OCR改为更可靠的TemplateMatch识别
- **功能稳定性增强**：通过精确的坐标参数和稳定的识别方法提升整体可靠性
...
**坐标参数优化**：
- **客人列表下滑**：起始坐标从[820, 501]调整为[286, 502]，结束坐标从[818, 174]调整为[286, 165]
- **点击停止坐标**：从[10347, 2121]调整为[10346, 2193]，提升点击精度
- **viewport坐标**：从[-1129, -165, 0.23]调整为[-9332, -1438, 0.99]，改善界面识别效果

**识别方法改进**：
- **菜单检测**：从OCR识别改为TemplateMatch模板匹配，提升识别稳定性和准确性
- **客人识别**：优化OCR识别参数，提高角色名称识别成功率
