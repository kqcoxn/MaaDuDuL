...
- **新增**：多节点识别策略在启动游戏功能中的应用，通过 custom_recognition_param 参数配置多个识别节点，提高识别稳定性和准确性
...
- [agent/customs/global_func/pinch_face.py:17-62](file://agent/customs/global_func/pinch_face.py#L17-L62)
- [agent/customs/global_func/logic_enhance.py:18-96](file://agent/customs/global_func/logic_enhance.py#L18-L96)
- [agent/customs/maahelper/reco_helper.py:17-256](file://agent/customs/maahelper/reco_helper.py#L17-L256)
- [agent/customs/maahelper/argv_analyzer.py:17-159](file://agent/customs/maahelper/argv_analyzer.py#L17-L159)
- [agent/customs/utils/prompter.py:16-55](file://agent/customs/utils/prompter.py#L16-L55)
- [agent/customs/utils/counter.py:75-141](file://agent/customs/utils/counter.py#L75-L141)
...
- ParamAnalyzer：参数解析器，支持 JSON 与查询字符串格式，**新增**：支持 custom_recognition_param 参数解析
...
- [agent/customs/utils/prompter.py:16-55](file://agent/customs/utils/prompter.py#L16-L55)
- [agent/customs/utils/counter.py:75-141](file://agent/customs/utils/counter.py#L75-L141)
- [agent/customs/maahelper/tasker.py:16-177](file://agent/customs/maahelper/tasker.py#L16-L177)
...
**图表来源**
- [agent/main.py:61-67](file://agent/main.py#L61-L67)
- [agent/customs/global_func/pinch_face.py:25-62](file://agent/customs/global_func/pinch_face.py#L25-L62)
- [agent/customs/global_func/logic_enhance.py:38-96](file://agent/customs/global_func/logic_enhance.py#L38-L96)
- [agent/customs/maahelper/reco_helper.py:62-94](file://agent/customs/maahelper/reco_helper.py#L62-L94)
- [agent/customs/maahelper/argv_analyzer.py:103-131](file://agent/customs/maahelper/argv_analyzer.py#L103-L131)
- [agent/customs/utils/prompter.py:34-54](file://agent/customs/utils/prompter.py#L34-L54)
- [agent/customs/utils/counter.py:87-112](file://agent/customs/utils/counter.py#L87-L112)
...
**章节来源**
- [agent/customs/global_func/pinch_face.py:17-18](file://agent/customs/global_func/pinch_face.py#L17-L18)
- [agent/customs/global_func/logic_enhance.py:18-19](file://agent/customs/global_func/logic_enhance.py#L18-L19)
- [agent/main.py:51-53](file://agent/main.py#L51-L53)
...
- **新增**：支持 custom_recognition_param 参数解析，这是 MaaFramework 传递给自定义识别器的标准参数格式
...
**图表来源**
- [agent/customs/maahelper/argv_analyzer.py:48-101](file://agent/customs/maahelper/argv_analyzer.py#L48-L101)
- [agent/customs/maahelper/argv_analyzer.py:103-131](file://agent/customs/maahelper/argv_analyzer.py#L103-L131)
- [agent/customs/maahelper/argv_analyzer.py:133-158](file://agent/customs/maahelper/argv_analyzer.py#L133-L158)

**章节来源**
- [agent/customs/maahelper/argv_analyzer.py:30-46](file://agent/customs/maahelper/argv_analyzer.py#L30-L46)
- [agent/customs/maahelper/argv_analyzer.py:103-131](file://agent/customs/maahelper/argv_analyzer.py#L103-L131)
...
**章节来源**
- [agent/customs/maahelper/reco_helper.py:34-34](file://agent/customs/maahelper/reco_helper.py#L34-L34)
- [agent/customs/maahelper/reco_helper.py:233-255](file://agent/customs/maahelper/reco_helper.py#L233-L255)
- [agent/customs/utils/prompter.py:48-54](file://agent/customs/utils/prompter.py#L48-L54)
...
- 参数：
  ...
  - **新增**：支持多节点识别，当为列表时，必须每个节点都识别到才算成功
- 流程要点：
  - 解析参数，支持单节点与多节点
  - 使用 CounterManager.get 生成计数器键，逐节点识别
  - **新增**：多节点模式下，任一节点未命中则重置计数器并返回 NoResult
  - **新增**：多节点模式下，只有全部节点命中且计数达到阈值时才返回识别结果
  - 全部命中且计数达到阈值时返回识别结果
...
CheckNode --> |是| CheckList{"是否为列表？"}
CheckList --> |是| BuildKeyList["生成多节点计数器键"]
CheckList --> |否| BuildKeySingle["生成单节点计数器键"]
BuildKeyList --> GetCounter["CounterManager.get(key)"]
BuildKeySingle --> GetCounter
...
### 多节点识别策略在启动游戏中的应用
- **应用场景**：启动游戏功能使用 stable_reco 识别器实现多节点识别策略
- **配置方式**：通过 custom_recognition_param 参数配置多个识别节点
- **实现效果**：提高识别的稳定性和准确性，避免单一节点识别的误判
- **配置示例**：
  - 主界面识别：`m=5&n=返回主界面_活动弹窗&n=返回主界面_使徒&n=返回主界面_冒险通行证`
  - 登录界面识别：`m=3&n=启动游戏_识别开始界面`

```mermaid
sequenceDiagram
participant Pipeline as "启动游戏管道"
participant StableReco as "StableReco识别器"
participant Node1 as "节点1"
participant Node2 as "节点2"
participant Node3 as "节点3"
participant Counter as "计数器"
Pipeline->>StableReco : "custom_recognition_param"
StableReco->>Counter : "获取计数器"
loop 遍历所有节点
StableReco->>Node1 : "识别节点1"
Node1-->>StableReco : "识别结果"
StableReco->>Node2 : "识别节点2"
Node2-->>StableReco : "识别结果"
StableReco->>Node3 : "识别节点3"
Node3-->>StableReco : "识别结果"
end
alt "所有节点都识别成功"
StableReco->>Counter : "计数器count()"
Counter-->>StableReco : "计数达到阈值"
StableReco-->>Pipeline : "返回识别结果"
else "任一节点识别失败"
StableReco->>Counter : "计数器reset()"
StableReco-->>Pipeline : "返回NoResult"
end
```

**图表来源**
- [assets/resource/base/pipeline/日常任务/启动游戏.json:364-371](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L364-L371)
- [assets/resource/base/pipeline/日常任务/启动游戏.json:387-394](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L387-L394)
- [agent/customs/global_func/logic_enhance.py:66-93](file://agent/customs/global_func/logic_enhance.py#L66-L93)

**章节来源**
- [assets/resource/base/pipeline/日常任务/启动游戏.json:364-371](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L364-L371)
- [assets/resource/base/pipeline/日常任务/启动游戏.json:387-394](file://assets/resource/base/pipeline/日常任务/启动游戏.json#L387-L394)
- [agent/customs/global_func/logic_enhance.py:62-93](file://agent/customs/global_func/logic_enhance.py#L62-L93)
...
- **新增**：启动游戏功能依赖多节点识别策略，通过 custom_recognition_param 参数实现
...
C --> G["CounterManager"]
D --> H["Tasker"]
I["启动游戏管道"] --> J["custom_recognition_param"]
J --> K["多节点识别配置"]
K --> C
```
...
- **新增**：多节点识别的性能优化：批量识别多个节点时，注意控制识别频率和阈值设置
- 批量点击与延迟：click_all 支持设置间隔与最大点击数，避免过度操作
- 任务监控：Tasker.run 自动注入监测器，确保任务可被监控与中断

**章节来源**
- [agent/customs/maahelper/reco_helper.py:62-94](file://agent/customs/maahelper/reco_helper.py#L62-L94)
- [agent/customs/maahelper/reco_helper.py:141-172](file://agent/customs/maahelper/reco_helper.py#L141-L172)
- [agent/customs/maahelper/reco_helper.py:208-230](file://agent/customs/maahelper/reco_helper.py#L208-L230)
- [agent/customs/maahelper/tasker.py:51-113](file://agent/customs/maahelper/tasker.py#L51-L113)
...
- **新增**：多节点识别失败：检查 custom_recognition_param 格式，确保所有节点都正确配置
...
- [agent/customs/utils/prompter.py:18-54](file://agent/customs/utils/prompter.py#L18-L54)
- [agent/customs/global_func/logic_enhance.py:94-95](file://agent/customs/global_func/logic_enhance.py#L94-L95)

## 结论
通过装饰器注册与标准回调签名，MaaFramework 为自定义识别器提供了清晰的扩展点。借助 RecoHelper、ParamAnalyzer、Prompter、CounterManager 等工具，开发者可以快速实现图像匹配、稳定识别等复杂逻辑，并在任务流水线中可靠地执行。**新增的多节点识别策略**进一步提升了识别的稳定性和准确性，特别是在启动游戏等关键场景中发挥了重要作用。遵循本文的规范与最佳实践，可有效提升识别准确性与系统稳定性。
...
- 常见参数格式
  - JSON：{"node": "节点名", "max": 3}
  - 查询字符串：node=节点名&m=3
  - **新增**：多节点配置：m=5&n=节点1&n=节点2&n=节点3
- **新增**：启动游戏多节点识别配置示例
  - 主界面识别：`m=5&n=返回主界面_活动弹窗&n=返回主界面_使徒&n=返回主界面_冒险通行证`
  - 登录界面识别：`m=3&n=启动游戏_识别开始界面`