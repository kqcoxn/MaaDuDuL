...
- [assets/resource/base/pipeline/日常任务/每日活动作战.json:1-671](file://assets/resource/base/pipeline/日常任务/每日活动作战.json#L1-L671)
...
P["assets/resource/base/pipeline/日常任务/每日活动作战.json"]
...
T["agent/customs/maahelper/reco_helper.py"]
...
## 结论
“每日活动作战”功能通过清晰的任务定义、灵活的流水线节点与自定义动作、可靠的 OCR 识别与周期性检查机制，实现了从活动入口到战斗挑战再到奖励领取的全链路自动化。配合依赖管理与环境准备模块，整体方案具备良好的可维护性与扩展性。
...
- 流水线节点与动作：[流水线:1-671](file://assets/resource/base/pipeline/日常任务/每日活动作战.json#L1-L671)
