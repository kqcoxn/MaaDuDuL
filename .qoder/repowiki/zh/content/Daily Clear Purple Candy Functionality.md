...
## 更新摘要
**所做更改**
- 更新金币大作战功能支持范围从13-20级扩展到13-24级
- 新增楼层检测和导航逻辑，支持B1/B2楼层间的自动切换
- 增强关卡选择系统的智能导航能力
- 更新关卡选择系统的技术细节以反映新的支持范围
...
**更新** 系统现已支持两种主要糖果资源的自动化清理，其中金币大作战功能得到重大增强：
...
- **SelectGoldLevel**: 金币大作战关卡选择（**更新**支持13-24级）
...
**更新** 新增的金币大作战功能依赖关系：
- **SelectGoldLevel**: 金币大作战关卡选择的核心动作
- **楼层检测**: OCR识别"B1"/"B2"入口按钮
- **RecoHelper**: 图像识别辅助器
...
| **金币楼层识别错误** | 无法正确识别B1/B2楼层 | OCR参数设置不当 | 调整OCR识别参数或ROI区域 |
...
该功能不仅为玩家提供了便利的游戏自动化解决方案，也为类似项目的开发提供了优秀的参考范例。新增的金币大作战楼层导航功能和红糖清除功能进一步增强了系统的实用性，为玩家提供了完整的糖果资源自动化清理体验。