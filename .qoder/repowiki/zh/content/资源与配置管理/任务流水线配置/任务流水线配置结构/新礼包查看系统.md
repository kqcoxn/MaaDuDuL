...
新礼包查看系统的核心是完整的任务流水线，包含多个精心设计的节点：
...
StoreCheck --> |否| WeeklyGift["检查每周礼包"]
EnterStore --> FaceCheck["捏脸检查<br/>检查特殊组合商品"]
FaceCheck --> WeeklyGift["检查每周礼包"]
WeeklyGift --> MonthlyGift["检查每月礼包"]
MonthlyGift --> CrystalLeaf["检查水晶叶"]
CrystalLeaf --> Interior["检查室内装潢"]
Interior --> PremiumStore["检查月卡商店"]
PremiumStore --> RecordPeriod["记录周期<br/>标记检查完成"]
