...
const description = ["MDDL 使用文档"].toString();
...
const teekConfig = defineTeekConfig({
    ...
    markdown: {
        demo: {
            githubUrl: "https://github.com/kqcoxn/MaaDuDuL/docsite",
        },
    },
    articleAnalyze: {
...
export default defineConfig({
    ...
    head: [
        ...
        ["meta", {property: "og:title", content: "MaaDuDuL - 文档站"}],
        ["meta", {property: "og:site_name", content: "MaaDuDuL"}],
    ...
    sitemap: {
        hostname: "https://mddl.codax.site",
    ...
    themeConfig: {
        ...
        editLink: {
            text: "在 GitHub 上编辑此页",
            pattern: "https://github.com/kqcoxn/MaaDuDuL/tree/main/docsite/docs/:path",
        },
    },
    vite: {
